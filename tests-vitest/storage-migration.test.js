...
test('migrateLegacyStorage: called from both the background worker and sidepanel.js init (function is shared, not duplicated)', () => {
  const bgSource = fs.readFileSync(path.join(__dirname, '..', 'public', 'background-main.js'), 'utf8');
  const panelSource = fs.readFileSync(path.join(__dirname, '..', 'public', 'sidepanel.js'), 'utf8');
